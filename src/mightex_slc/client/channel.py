...
set_normal_parameters, get_normal_parameters, set_active_mode, and
get_active_mode, and later slices add the rest. Like the Controller proxy, it holds no device state and no
