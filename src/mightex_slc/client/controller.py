...
capability questions answer without a round trip. Its methods each build the
matching device-level contract request and send it through link; this slice
carries close, and later slices add the rest.
