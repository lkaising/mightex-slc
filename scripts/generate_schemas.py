...
OPERATIONS: dict[str, tuple[Any, Any]] = {
    ...
    "set_trigger_parameters": (SetTriggerParametersRequest, SetTriggerParametersReply),
    "get_trigger_parameters": (GetTriggerParametersRequest, GetTriggerParametersReply),
    "set_trigger_profile": (SetTriggerProfileRequest, SetTriggerProfileReply),
    "get_trigger_profile": (GetTriggerProfileRequest, GetTriggerProfileReply),
